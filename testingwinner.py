...
with open('SimulationEvolution\winner_genome_badfinal.pkl', 'rb') as f:
...
# Create the network from the loaded genome
net = neat.nn.FeedForwardNetwork.create(winner, config)

for i in range(50):
    input_data = [100,i,100,100,0,0]
...
#         output = net.activate(tuple(input)) 
